...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of JokeLib in Markdown format.
  ...
  s.homepage     = "http://EXAMPLE/JokeLib"
  ...
  # s.authors      = { "503315533" => "503315533@qq.com", "other author" => "email@address.com" }
  # s.author       = '503315533', 'other author'
  ...
  s.source_files  = ‘SampleClasses', 'SampleClasses/**/*.{h,m}'
